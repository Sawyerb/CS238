...
# data  = np.load('basic_big_pomcpow_contributions.npy')
# data = np.mean(data, 2)
# print(data)
# fig, ax = plt.subplots()
...
# plt.savefig('basic_big_pomcpow_contributions.png')
# plt.show()
...
# im, cbar = heatmap(data,ax=ax, col_labels = range(100, 600, 100), row_labels= range(0, 110, 10),
